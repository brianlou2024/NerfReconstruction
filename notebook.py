...
print(basedir)
args = parser.parse_args('--config {} --ft_path {}'.format(config, os.path.join(basedir, expname, 'model_060000.npy')))
print('loaded args')
args.datadir = "/scratch/gpfs/blou/Colgate/TestSet16"
...
plt.show()
print("after")
out = cv2.VideoWriter('logs/colgate16.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps,(W,H))
down = 1
